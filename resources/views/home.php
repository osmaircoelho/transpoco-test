...
<head>
    <title>Transpoco Employees Database</title>

    <!-- Load Bootstrap CSS -->
    <link href="<?= asset('css/bootstrap/bootstrap.css') ?>" rel="stylesheet">
</head>
<body>
<h2>Transpoco Employees Database</h2>
...
<!--<div id="modal-message" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body alert-success"></div>
            <div class="modal-footer">
...
<script src="<?= asset('app/lib/angular/angular_1.4.js') ?>"></script>
